...
/* @var $searchModel modava\website\models\search\PhonebookSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Danh bạ');
                                    ...
                                    ',
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'value' => function ($model) {
                                                    $content = $model->phone;
                                                    if (class_exists('modava\voip24h\CallCenter') || class_exists('modava\vht\CallCenter')) $content .= ' ' . Html::a('<i class="fa fa-phone"></i>', 'javascript: void(0)', [
